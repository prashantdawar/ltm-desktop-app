...
import { CommonControlValueAccessor } from 'src/app/modals_core/CommonControlValueAccessor';
import { CustomValidation } from '../../../modals_core/Customvalidation';
...
export class BootstrapFormInputComponent extends CustomValidation implements OnInit, ControlValueAccessor, Validator {
  id: string = "id";
